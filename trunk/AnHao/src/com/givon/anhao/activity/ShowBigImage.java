...
import com.givon.anhao.task.LoadLocalBigImgTask;
import com.givon.anhao.utils.ImageCache;
import com.givon.anhao.widget.photoview.PhotoView;
...
public class ShowBigImage extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (uri != null && new File(uri.getPath()).exists()) {
			...
			if (bitmap == null) {
				LoadLocalBigImgTask task = new LoadLocalBigImgTask(this, uri.getPath(), image,
						loadLocalPb, ImageUtils.SCALE_IMAGE_WIDTH, ImageUtils.SCALE_IMAGE_HEIGHT);
	...
	private void downloadImage(final String remoteFilePath, final Map<String, String> headers) {
		...
		final HttpFileManager httpFileMgr = new HttpFileManager(this, EMChatConfig.getInstance()
				.getStorageUrl());
