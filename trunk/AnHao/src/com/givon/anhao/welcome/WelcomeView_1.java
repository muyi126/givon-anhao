...
public class WelcomeView_1 implements Animator.AnimatorListener {
	...
	private void init(Context context) {
		...
		sinaStart = (Button) view.findViewById(R.id.sinaStart);
		sinaStart.setOnClickListener(new OnClickListener() {
	 ...
	 * 新浪
	 */
	private void lodingXN(final Context context) {
