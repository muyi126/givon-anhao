...
public class WelcomeView_4 implements Animator.AnimatorListener{
	...
	public WelcomeView_4(Context context) {
		super();
		mContext = context;
		init(context);
	}
	...
	private void init(Context context) {
		view = (View) LayoutInflater.from(context).inflate(R.layout.layout_welcome_anhao_4, null);
