...
public class WelcomeView_2 implements Animator.AnimatorListener{
	...
	public WelcomeView_2(Context context) {
		super();
		mContext = context;
		init(context);
	}
	...
	private void init(Context context) {
		view = (View) LayoutInflater.from(context).inflate(R.layout.layout_welcome_anhao_2, null);
